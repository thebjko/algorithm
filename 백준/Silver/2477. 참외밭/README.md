...
while l[:2]!=[l[2]+l[4],l[3]+l[5]]:l=l[1:]+[l[0]]
print(n*(l[0]*l[1]-l[4]*l[3]))

# equivalently:
n, *l = map(int, open(0).read().split()[::2])   # 필요한 부분만 추리기
while l[:2] != [l[2] + l[4], l[3] + l[5]]:   # 처음 두개의 원소가 각각 세 번째, 다섯 번째 원소의 합과 네 번째, 여섯 번째 원소의 합이 아니라면
  l = l[1:] + [l[0]]   # 첫번째 원소를 맨 뒤로 보낸다
